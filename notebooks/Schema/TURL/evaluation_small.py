...
data_dir = '/pfs/work7/workspace/scratch/ma_luitheob-tp2021/turl/turl-base/small/input/'
...
from tqdm.autonotebook import tqdm
checkpoints = [
    "small/output/mode_0/pytorch_model.bin",
    "small/output/mode_3/pytorch_model.bin",
    "small/output/mode_4/pytorch_model.bin"
]
