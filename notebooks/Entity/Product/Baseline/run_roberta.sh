...
python transformer_roberta_debugged.py \
    ...
    --validation_file /pfs/work7/workspace/scratch/ma_nsabel-  teamprojekt/data_integration_using_deep_learning/src/data/product/train_test_split/output_unfiltered_tables/large/after_manual_checking/baselines/df_val \
