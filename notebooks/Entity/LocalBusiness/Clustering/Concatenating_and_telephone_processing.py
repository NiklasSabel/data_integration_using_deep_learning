...
path = r"../../../../src/data"
lb_path_min3 = path + r"/LocalBusiness/LocalBusiness_minimum3/geo_preprocessed_v2"
lb_path_top100 = path + r"/LocalBusiness/LocalBusiness_top100/geo_preprocessed_v2"
# lb_path_rest = path + r"/LocalBusiness/LocalBusiness_rest/geo_preprocessed"
rest_path_min3 = path + r"/Restaurant/Restaurant_minimum3/geo_preprocessed_v2"
rest_path_top100 = path + r"/Restaurant/Restaurant_top100/geo_preprocessed_v2"
# rest_path_rest = path + r"/Restaurant/Restaurant_rest/geo_preprocessed"
hotel_path_min3 = path + r"/Hotel/Hotel_minimum3/geo_preprocessed_v2"
hotel_path_top100 = path + r"/Hotel/Hotel_top100/geo_preprocessed_v2"
...
df_valid_numbers["E.164 format"] = df_valid_numbers["phone_object"].apply(
...
df_valid_numbers.to_json("New_Concatenated_MatchingFile", compression="gzip", orient='records', lines=True)
print("success")
